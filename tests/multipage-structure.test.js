...
test("index conserva el login y la aplicación monolítica originales",()=>{const html=readFileSync(join(pagesRoot,"index.html"),"utf8");assert.match(html,/id="login-form"/);assert.match(html,/id="app"/);assert.match(html,/src="\.\.\/js\/index\.js"/);assert.match(html,/href="\.\.\/styles\/index\.css"/)});
